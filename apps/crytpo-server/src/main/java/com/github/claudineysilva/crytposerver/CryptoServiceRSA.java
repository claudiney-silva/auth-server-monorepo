...
public class CryptoServiceRSA {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            final String msgOriginal = "One possible solution would be to utilize the Tasks feature of VSCode and pass the project root path to your compiler as a preprocessor macro using the -D option, after which you could use it in your sourcecode.\n" +
                    "\n" +
